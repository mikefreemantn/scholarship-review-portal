...
export const sendEmail = async (params: EmailParams): Promise<boolean> => {
  ...
  try {
    const response = await fetch('https://9i79qw9g89.execute-api.us-east-2.amazonaws.com/send-email', {
      method: 'POST',
      headers: {
    ...
    console.log('Email sent successfully via SendGrid Lambda');
    return true;
  } catch (error: any) {
                    ...
                    <tr>
                      <td style="padding: 25px;">
                        ...
                        <p style="color: #333; margin: 0 0 15px 0; font-size: 15px;">
                          <strong style="color: #2d4a3e;">Temporary Password:</strong><br>
                        ...
                        <p style="color: #666; margin: 0; font-size: 13px; line-height: 1.5;">
                          ⚠️ <strong>You'll be prompted to create a new password</strong> when you first log in. This temporary password will only work once.
                        </p>
                      </td>
                    </tr>
                  </table>
...
IMPORTANT: You'll be prompted to create a new password when you first log in. This temporary password will only work once.
